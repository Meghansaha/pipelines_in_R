...
<center><img src= "images/int_ext.png", alt="an image that shows visuals of components of an pipelines potential internal and external structures. With the external on the left side and internal on the right." height = 450px></center>
