...
<br>
<img src="images/metaexample.png" alt="A screenshot of a metadata table that comes from a datasets codebook. Metadata can consist of data about the data with information such as file types, variable types, administrators, methods of collection, etc." width = "50%" height = "50%"></center>
